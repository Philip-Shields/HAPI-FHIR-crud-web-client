...
<form name="queryForm" id="patientForm" method="post" action="FindPractitionerServlet">
...
<b> Enter practitioner's id number to find </b>

  <input type="text" name="practitionerId" value="" size="30"> <br>
