...
<form name="queryForm" id="patientForm" method="post" action="AddPatientServlet">
...
<select  name="gender">
 ...
 <p>
 Patients' family name.<br>
  <input type="text" name="famName"size="10" required><br>
  
  
  Patients' given name.<br>
  <input type="text" name="givenName" size="10" required><br>
  Patients' usual name.<br>
  <input type="text" name="usualName"  value = "" size="10"> <br>
  
  Patients' birthdate YYYY-MM-dd<br>
  <input type="text" name="ptBirthDate" size="10" required><br>
  UR number.<br>
  <input type="text" name="urNumber"  size="10"  required><br>
  Medibank  number.<br>
  <input type="text" name="mediBankNumber" value= "3456509872" size="10"  required><br>
  Patients' street number and street name.
  ...
  Language.<br>
  <input type="text" name="language" size="18" required><br>
  Patients' home phone.<br>
  <input type="text" name="homePhone"  value = "" size="18" required><br>
  Patients' work phone.<br>
  <input type="text" name="workPhone" value= "" size="18" ><br>
  Patients' mobile phone.<br>
  <input type="text" name="mobilePhone" value= "" size="18"><br>
  Patients' email.<br>
  <input type="text" name="email" value = "" size="18" ><br>
  Patients' general practitioner code.<br>
  <input type="text" name="generalPractitioner" value="Practitioner/5795" size="10"> <br>
  <p>
  <b>Patients' contacts</b><br>
  
   Primary contact relationship to patient.<br>
  <input type="text" name="primaryContactRelationship" value= "" size="10" ><br> 
   Primary contact name.<br>
  <input type="text" name="primaryContactGivenName" value= "" size="10" ><br>  
  Primary contact home phone.<br>  
  <input type="text" name="primaryContactHomePhone" value= "" size="18"><br>
  Primary contact work phone.<br>
  <input type="text" name="primaryContactWorkPhone" value= "" size="18" ><br>
  Primary contact mobile phone.<br>
  <input type="text" name="primaryContactMobilePhone" value= "" size= "18"> <br>
  <p>
	
Secondary contact relationship to patient.<br>
  <input type="text" name="secondaryContactRelationship" value= "" size="10"><br> 
   Secondary contact name.<br>
  <input type="text" name="secondaryContactGivenName" value= "" size="10"><br>  
  Secondary contact home phone.<br>  
  <input type="text" name="secondaryContactHomePhone" value= "" size="18" ><br>
  Secondary contact work phone.<br>
  <input type="text" name="secondaryContactWorkPhone" value= "" size="18" ><br>
  Secondary contact mobile phone.<br>
  <input type="text" name="secondaryContactMobilePhone" value= "" size="18" ><br>
  <p>
