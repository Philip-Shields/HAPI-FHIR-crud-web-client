...
<form name="queryForm" id="patientForm" method="post" action="DeletePatientsServlet">
...
<b> Enter patient's id number to delete </b>

  <input type="text" name="patientId"size="10" value="${patientId}"><br>
