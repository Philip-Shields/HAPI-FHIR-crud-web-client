...
<form name="queryForm" id="patientForm" method="post" action="ListPatientsServlet">
...
<b> Enter patient's surname </b>

  <input type="text" name="familyName"size="10" required><br>
